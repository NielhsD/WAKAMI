...
//Código para function de puntero y scroll 
console.clear();
...
class PointerParticle {
    constructor(spread, speed, component) {
      ...
      // Alternar colores entre plateado y rosado
    this.color = Math.random() > 0.5 ? `hsl(${Math.random() * 60 + 300}, 100%, 70%)` : `hsl(0, 0%, ${Math.random() * 20 + 80}%)`; // Rosado y Plateado
    }
